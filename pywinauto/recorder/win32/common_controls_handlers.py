...
_E_NOTIFICATIONS = {
    # win32defines.EN_ALIGN_LTR_EC,
    # win32defines.EN_ALIGN_RTL_EC,
...
_LV_NOTIFICATIONS = {
    # win32defines.LVN_BEGINLABELEDIT : "LVN_BEGINLABELEDIT",
...
_TV_NOTIFICATIONS = {
    ...
    # win32defines.TVN_BEGINDRAG : "TVN_BEGINDRAG",
    # win32defines.TVN_BEGINLABELEDIT : "TVN_BEGINLABELEDIT",
    # win32defines.TVN_BEGINRDRAG : "TVN_BEGINRDRAG",
    # win32defines.TVN_DELETEITEM : "TVN_DELETEITEM",
    # win32defines.TVN_ENDLABELEDIT : "TVN_ENDLABELEDIT",
    # win32defines.TVN_GETDISPINFO : "TVN_GETDISPINFO",
    # win32defines.TVN_GETINFOTIP : "TVN_GETINFOTIP",
    # win32defines.TVN_ITEMCHANGED : "TVN_ITEMCHANGED",
    # win32defines.TVN_ITEMCHANGING : "TVN_ITEMCHANGING",
    # win32defines.TVN_ITEMEXPANDED : "TVN_ITEMEXPANDED",
    # win32defines.TVN_ITEMEXPANDING : "TVN_ITEMEXPANDING",
    # win32defines.TVN_KEYDOWN : "TVN_KEYDOWN",
    # win32defines.TVN_SELCHANGED : "TVN_SELCHANGED",
    # win32defines.TVN_SELCHANGING : "TVN_SELCHANGING",
    # win32defines.TVN_SETDISPINFO : "TVN_SETDISPINFO",
...
_HD_NOTIFICATIONS = {
    ...
    # win32defines.HDN_BEGINTRACK : "HDN_BEGINTRACK",
    # win32defines.HDN_DIVIDERDBLCLICK : "HDN_DIVIDERDBLCLICK",
    # win32defines.HDN_DROPDOWN : "HDN_DROPDOWN",
    # win32defines.HDN_ENDFILTEREDIT : "HDN_ENDFILTEREDIT",
    # win32defines.HDN_ENDTRACK : "HDN_ENDTRACK",
    # win32defines.HDN_FILTERBTNCLICK : "HDN_FILTERBTNCLICK",
    # win32defines.HDN_FILTERCHANGE : "HDN_FILTERCHANGE",
    # win32defines.HDN_GETDISPINFO : "HDN_GETDISPINFO",
    # win32defines.HDN_ITEMCHANGED : "HDN_ITEMCHANGED",
    # win32defines.HDN_ITEMCHANGING : "HDN_ITEMCHANGING",
    # win32defines.HDN_ITEMCLICK : "HDN_ITEMCLICK",
    # win32defines.HDN_ITEMDBLCLICK : "HDN_ITEMDBLCLICK",
    ...
    # win32defines.HDN_TRACK : "HDN_TRACK",
...
_TB_NOTIFICATIONS = {
    ...
    # win32defines.TBN_GETINFOTIP : "TBN_GETINFOTIP",
    ...
    # win32defines.TBN_GETBUTTONINFO : "TBN_GETBUTTONINFO",
    # win32defines.TBN_GETDISPINFO : "TBN_GETDISPINFO",
...
_TT_NOTIFICATIONS = {
    # win32defines.TTN_GETDISPINFO : "TTN_GETDISPINFO",
    # win32defines.TTN_LINKCLICK : "TTN_LINKCLICK",
    # win32defines.TTN_NEEDTEXT : "TTN_NEEDTEXT",
