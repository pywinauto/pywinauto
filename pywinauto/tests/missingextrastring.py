...
MissingOrExtra	Whether the characters are missing or extra from the
                controls being check as compared to the
                reference, (String with following possible values)
                    "MissingCharacters"	The characters are in the reference
                                        but not in the localised.
                    "ExtraCharacters"	The characters are not in the reference
                        				but are in the localised.
